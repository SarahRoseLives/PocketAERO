...
/* AMBE voice frame callback — 12 bytes (96 bits) per frame, 25 frames per C-channel block */
...
public:
    ...
    void setVoiceFrameCallback(aerol_voice_cb cb, void *user) { voice_cb = cb; voice_user = user; }
